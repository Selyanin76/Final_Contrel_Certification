...
public class JavaControl1 {
    ...
    public static void main(String[] args) {
        ...
        laptops.add(new Laptop("ASUS", 8, 256, "MacOS", "Silver"));
        laptops.add(new Laptop("Apple", 16, 256, "Linux", "Silver"));
        laptops.add(new Laptop("LOC", 8, 512, "Linux", "Black"));
        laptops.add(new Laptop("Aser", 8, 1024, "MacOS", "Gray"));
       ...
       Scanner scanner = new Scanner(System.in);
        ...
        System.out.println("Введите поочередно желаемые параметры:");
